...
export default class Base {
   ...
   */
    constructor(context, document) {
        ...
        let isSafari = /constructor/i.test(window.HTMLElement) || (function (p) { return p.toString() === "[object SafariRemoteNotification]"; })(!window['safari'] || (typeof safari !== 'undefined' && safari.pushNotification)); // eslint-disable-line no-undef
        ...
        if(isSafari) {
            ...
            document.addEventListener('fullscreenchange', (event) => { // eslint-disable-line no-unused-vars
   ...
   */
    ...
    onSoundEvent(e){ // eslint-disable-line no-unused-vars
